...
// 直接 import（ESM 模块）
const kuaishouModule = await import('../src/main/login/kuaishou.js')
const classInstance = kuaishouModule.default

// ✅ 从同一模块解构出 CHROME_USER_AGENT(已 export)
const { CHROME_USER_AGENT } = kuaishouModule

async function main() {
  console.log('=== [test-kuaishou-login-class] starting ===')
