...
// 直接 import（ESM 模块）
const wxchannelModule = await import('../src/main/login/wxchannels.js')
const classInstance = wxchannelModule.default
// ✅ 从同一模块解构出 CHROME_USER_AGENT(已 export)
const { CHROME_USER_AGENT } = wxchannelModule

async function main() {
  console.log('=== [test-wxchannel-login-class] starting ===')
