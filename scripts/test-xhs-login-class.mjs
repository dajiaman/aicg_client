...
// 直接 import（ESM 模块）
const xhsModule = await import('../src/main/login/xiaohongshu.js')
const classInstance = xhsModule.default
// ✅ 从同一模块解构出 CHROME_USER_AGENT(已 export)
const { CHROME_USER_AGENT } = xhsModule

async function main() {
  console.log('=== [test-xhs-login-class] starting ===')
